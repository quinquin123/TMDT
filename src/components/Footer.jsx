      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to={`#`} className="hover:text-blue-400">Hướng dẫn mua hàng</Link></li>
              <li><Link to={`#`} className="hover:text-blue-400">Chính sách bảo hành</Link></li>
              <li><Link to={`#`} className="hover:text-blue-400">Chính sách đổi trả</Link></li>
              <li><Link to={`#`} className="hover:text-blue-400">Câu hỏi thường gặp</Link></li>
              <li><Link to={`#`} className="hover:text-blue-400">Liên hệ hỗ trợ</Link></li>
            </ul>
          </div>
